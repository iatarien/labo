            ...
            @include('components.topbar')
                ...
                <div class="container-fluid" dir="rtl" style="text-align : right">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="/update_labo" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{$labo->id_labo}}">
                                <div id="some" class="form-group row">
                                    <label  class="control-label col-lg-2 text-right" for="title">الـ{{$t}}</label>
                                    <div class="col-lg-8">
                                    <input type="text" name="name_labo" required  class="form-control" value ="{{$labo->name_labo}}">
                                    </div>
                                </div>
