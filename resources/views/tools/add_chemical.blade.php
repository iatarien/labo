            ...
            @include('components.topbar')
                ...
                <div class="container-fluid" dir="rtl" style="text-align : right">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="/insert_chemical" method="POST">
                                @csrf
                                <div id="some" class="form-group row">
                                    <label  class="control-label col-lg-2 text-right" for="title">اسم الـ{{$t}}</label>
                                    <div class="col-lg-8">
                                    <input type="text" name="name_chemical" required  class="form-control" value ="">
                                    </div>
                                </div>
                                <div id="some"   class="form-group row">
                                    <label  class="control-label col-lg-2 text-right" for="title">الوحدة</label>
                                    <div class="col-lg-8">
                                    <input type="text" name="unity" required class="form-control" value ="">
                                    </div>
                                </div>
                                <div id="some"   class="form-group row">
